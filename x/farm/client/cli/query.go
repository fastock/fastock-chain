...
Example:
$ %s query farm rewards pool-eth-xxb blockchain1hw4r48aww06ldrfeuq2v438ujnl6alsz0685a0
`,
				version.ClientName,
			),
		),
...
Example:
$ %s query farm account blockchain1hw4r48aww06ldrfeuq2v438ujnl6alsz0685a0
`,
				version.ClientName,
			),
		),
...
Example:
$ %s query farm lock-info pool-eth-xxb blockchain1hw4r48aww06ldrfeuq2v438ujnl6alsz0685a0 
`,
				version.ClientName,
			),
		),
