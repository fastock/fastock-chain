...
// nolint
const (
	EngineTypeSqlite = blockchaincfg.BackendOrmEngineTypeSqlite
	EngineTypeMysql  = blockchaincfg.BackendOrmEngineTypeMysql
)

// nolint
type OrmEngineInfo = blockchaincfg.BackendOrmEngineInfo
