...
import (
	...
	ethcdc "github.com/fastock/fastock-chain/app/codec"
)
...
// file.
func (app *BlockchainApp) ExportAppStateAndValidators(
...
func (app *BlockchainApp) prepForZeroHeightGenesis(ctx sdk.Context, jailWhiteList []string) {
