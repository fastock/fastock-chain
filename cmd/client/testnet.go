...
Note, strict routability for addresses is turned off in the config file.`,
		...
		Example: "fastock-chain-daemon testnet --v 4 --keyring-backend test --output-dir ./output --starting-ip-address 192.168.10.2",
	...
	cmd.Flags().String(flagNodeDaemonHome, "fastock-chain-daemon", "Home directory of the node's daemon configuration")
	cmd.Flags().String(flagNodeCLIHome, "fastock-chain-cli", "Home directory of the node's cli configuration")
