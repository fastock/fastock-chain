...
import (
	...
	ammswaprest "github.com/fastock/fastock-chain/x/ammswap/client/rest"
	backendrest "github.com/fastock/fastock-chain/x/backend/client/rest"
	dexclient "github.com/fastock/fastock-chain/x/dex/client"
	dexrest "github.com/fastock/fastock-chain/x/dex/client/rest"
	dist "github.com/fastock/fastock-chain/x/distribution"
	distr "github.com/fastock/fastock-chain/x/distribution"
	distrest "github.com/fastock/fastock-chain/x/distribution/client/rest"
	evmrest "github.com/fastock/fastock-chain/x/evm/client/rest"
	farmclient "github.com/fastock/fastock-chain/x/farm/client"
	farmrest "github.com/fastock/fastock-chain/x/farm/client/rest"
	govrest "github.com/fastock/fastock-chain/x/gov/client/rest"
	orderrest "github.com/fastock/fastock-chain/x/order/client/rest"
	paramsclient "github.com/fastock/fastock-chain/x/params/client"
	stakingrest "github.com/fastock/fastock-chain/x/staking/client/rest"
	"github.com/fastock/fastock-chain/x/token"
	tokensrest "github.com/fastock/fastock-chain/x/token/client/rest"
