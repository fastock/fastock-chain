...
Thank you for considering making contributions to faStock-Chain and related
repositories!
...
1. Either [open](https://github.com/fastock-chain/fastock-chain/issues/new/choose) or
   [find](https://github.com/fastock/fastock-chain/issues) an issue you'd like to help with
...
3. If you would like to contribute:
   ...
   4. Follow standard Github best practices: fork the repo, branch from the
      ...
      - For core developers working within the faStock-Chain repo, to ensure a clear
...
Take a peek at our [coding repo](https://github.com/okex/coding) for
...
Other notes:
  - Looking for a good place to start contributing? How about checking out some
    [good first issues](https://github.com/fastock/fastock-chain/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22)
...
While my fork lives at `https://github.com/rigeyrigerige/fastock-chain`,
the code should never exist at  `$GOPATH/src/github.com/rigeyrigerige/fastock-chain`.
Instead, we use `git remote` to add the fork as a new remote for the original repo,
`$GOPATH/src/github.com/fastock/fastock-chain `, and do all the work there.

For instance, to create a fork and work on a branch of it, I would:

  - Create the fork on github, using the fork button.
  - Go to the original repo checked out locally (i.e. `$GOPATH/src/github.com/fastock/fastock-chain`)
  - `git remote rename origin upstream`
  - `git remote add origin git@github.com:rigeyrigerige/fastock-chain.git`

Now `origin` refers to my fork and `upstream` refers to the faStock-Chain version.
So I can `git push -u origin master` to update my fork, and make pull requests to faStock-Chain from there.
...
### Development Procedure
  ...
  - create a development branch either on github.com/fastock/fastock-chain, or your fork (using `git remote add origin`)
